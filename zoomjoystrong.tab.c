...
static const char *const yytname[] =
{
  ...
  "zoomjoystrong", "drawing", "shape", "draw_line", "draw_circle",
  "draw_point", "draw_rectangle", "set_the_color", "end_program", YY_NULLPTR
};
#endif
...
static const yytype_int8 yypact[] =
{
      -4,    -5,    -3,    -2,    -1,     0,     1,     6,     8,    -4,
      -5,    -5,    -5,    -5,    -5,    -5,     3,     4,     5,     7,
       9,    -5,    -5,    -5,    13,    10,    11,    12,    14,    -5,
      15,    20,    16,    24,    25,    -5,    26,    -5,    -5,    -5
};
...
static const yytype_int8 yydefact[] =
{
       ...
       0,     1,     2,     4,     0,     0,     0,     0,     0,    13,
       0,     0,     0,     0,     0,    12,     0,    15,    11,    14
};

  /* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
      -5,    -5,    21,    -5,    -5,    -5,    -5,    -5,    -5,    23
};
...
{
       1,     2,     3,     4,     5,     6,    21,    16,    17,    18,
      19,    20,     1,    24,    25,    26,    29,    27,     0,    28,
      30,    31,    32,    35,    33,    34,    36,    37,    38,    39,
      23,    22
};
...
static const yytype_int8 yycheck[] =
{
      ...
      10,    10,     4,    10,    10,    10,     3,    10,    -1,    10,
      10,    10,    10,     3,    10,    10,    10,     3,     3,     3,
       9,     8
};
...
#line 57 "zoomjoystrong.y"
                                                                        {check_line((yyvsp[-4].i), (yyvsp[-3].i), (yyvsp[-2].i), (yyvsp[-1].i));}
#line 1340 "zoomjoystrong.tab.c"
    break;

  case 12:
#line 59 "zoomjoystrong.y"
                                                                        {check_circle((yyvsp[-3].i), (yyvsp[-2].i), (yyvsp[-1].i));}
#line 1346 "zoomjoystrong.tab.c"
    break;

  case 13:
#line 61 "zoomjoystrong.y"
                                                                        {check_point((yyvsp[-2].i), (yyvsp[-1].i));}
#line 1352 "zoomjoystrong.tab.c"
    break;

  case 14:
#line 63 "zoomjoystrong.y"
                                                                        {check_rectangle((yyvsp[-4].i), (yyvsp[-3].i), (yyvsp[-2].i), (yyvsp[-1].i));}
#line 1358 "zoomjoystrong.tab.c"
    break;

  case 15:
#line 65 "zoomjoystrong.y"
                                                                        {check_color((yyvsp[-3].i), (yyvsp[-2].i), (yyvsp[-1].i));}
#line 1364 "zoomjoystrong.tab.c"
    break;
